...
/***************************************************************************//**
  ...
  #t_clock для представления текущего значения системного счетчика.
  ...
  Для работы с API таймера, необходимо объявить переменную типа #t_time, которая
...
/***************************************************************************//**
  ...
  @note  Время стабатывания периодического таймер будет "плыть" при использовании
